...
sub PMM_INIT(mb_info as multiboot_info ptr)
    CONSOLE_WRITE(@"Physical pages allocator initializing ...")
    ...
    CONSOLE_WRITE_TEXT_AND_SIZE(@"UPER MEMORY          :",(mb_info->mem_upper)*1024,true)
    CONSOLE_WRITE_TEXT_AND_DEC (@"Availables free page :",TotalPagesCount,true)
end sub
