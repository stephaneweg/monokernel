...
dim shared TIMER_WAIT as unsigned integer
dim shared TIMER_COUNTER as unsigned integer

declare function TIMER_IRQ(stack as IRQ_STACK ptr) as IRQ_STACK ptr
declare sub TIMER_DELAY(compteur as unsigned integer)
